...
class FraudDetectionModel(FrogMlModel):
    ...
    def __init__(self):
        ...
        self.param_grid = {
            ...
            'l2_leaf_reg': [1], 'border_count': [32], 'random_strength': [0.1], 'verbose': [0]
        }
    ...
    def build(self):
        ...
        frogml.log_metric({'accuracy': accuracy_score(y_test, y_test_pred), 'f1_score': f1_score(y_test, y_test_pred)})
    ...
    def schema(self):
        return ModelSchema(
            ...
            outputs=[InferenceOutput(name="Fraud", type=int)])
